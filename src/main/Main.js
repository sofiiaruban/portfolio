            ...
            <main className='hero'>
                ...
                <div id= 'projects' className='projects'>
                    ...
                    <div className='gallery'>
                        <a href='https://sofiiaruban.github.io/adaptive-project/'><img src={logo_app}></img></a>
                        <a href='https://sofiiaruban.github.io/keyboard-app/'><img src={keyboard_app}></img></a>
                        <a href='https://sofiiaruban.github.io/weather-app/'><img src={weather_app}></img></a>
                    </div>
                </div> 
                <div id='contact' className='contact'>
                    ...
                    <ul className='contact-list'>
                        ...
                        <li>
                            <FiMail />
                            <a href="mailto:sofiiaruban@outlook.com">sofiiaruban@outlook.com</a>
                        </li>
                        <li></li>
                    </ul>
                </div> 
